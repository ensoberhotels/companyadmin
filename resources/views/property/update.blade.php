                        ...
                        <div class="row">
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text" name="property_name" value="{{$record->property_name}}" id="property_name" class="form-control">
                            </div>
                          </div>
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                          ...
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text" name="name" id="name" value="{{$record->user}}" class="form-control">
                            </div>
                          </div>
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                              <label class="active">Password</label>
                              <input type="password" name="password" value="{{$record->password}}" id="password" class="form-control">
                            </div>
                          </div>
                        </div>
...
.iziToast>.iziToast-body .iziToast-title {
    ...
    <!-- END PAGE LEVEL JS-->
       ...
       function updateData(){
         ...
         jQuery.ajax({
          type: "POST",
          url: '/company_admin/property/update',
          data: form,
          processData: false,
          contentType: false,
          dataType: "json",
