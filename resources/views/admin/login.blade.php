    ...
    <form class="login-form" action="{{ URL::to('/company_admin/login') }}" method="post">
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <a href="{{URL::to('/company_admin/forget-password')}}" class="btn waves-effect border-round btn-primary col s6" style="background-color: #303f9f;margin-left: 7px;width: 48%;">Forget Password</a>
        </div>
      </div>
      <!--<div class="row">
