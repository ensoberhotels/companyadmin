                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                             ...
                             <input type="text" name="company_desc" id="company_desc" class="form-control"> 
                            </div>
                          </div>
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                             ...
                             <textarea type="text" name="company_add" id="company_add" class="form-control"> </textarea>
                            </div>
                          </div>
                          <div class=" col-sm-12 col-md-3" style="width: 25%;">
                            <button class="btn waves-effect waves-light left" type="button" onclick="saveData()" name="action" id="add_hotel">Save
                              <i class="material-icons right">send</i>
                            </button>
                            <a href="{{URL::to('/company-master')}}" class="btn waves-effect waves-dark" style="background-color: #bfb32b;color: #fff;">Back</a>
                          </div>
                        </div>
            </form>
                </div>
