                  ...
                  <div class="card">
                    <div class="card-content">
                      <div class="card-header">
                          <h4 class="card-title">Update Your Info</h4>
                      </div>
                        ...
                        <div class="row">       		
                          ...
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                             ...
                             <a href="{{ asset('public/asset/company_logo/') }}/{{$record->c_logo}}" target="_blank"><img src="{{ asset('public/asset/company_logo/') }}/{{$record->c_logo}}" height="50" width="50" alt="tag"> </a>
                            </div>
                          </div>
				                  <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class=" col-sm-12 col-md-3" style="width: 25%;">
                            ...
                            <a href="{{URL::to('/company_admin/company-master')}}" class="btn waves-effect waves-dark"   style="background-color: #bfb32b;color: #fff;height: 26px;padding: 6px 4px;font-size: 12px;line-height: 1;">Back</a>
                          </div>
                        </div>
            </form>
                </div>
